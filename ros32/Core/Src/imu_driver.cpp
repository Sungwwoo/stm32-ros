...
void ImuDriver::MPU9250_SetAccelRange(AccelRange range)
{
	writeRegister(ACCEL_CONFIG, range);
}

/* sets the gyro full scale range to values other than default */
void ImuDriver::MPU9250_SetGyroRange(GyroRange range)
{
	writeRegister(GYRO_CONFIG, range);
}
void ImuDriver::MPU9250_SetSampleRateDivider(SampleRateDivider srd)
{
...
void ImuDriver::MPU9250_SetDLPFBandwidth(DLPFBandwidth bandwidth)
{
...
void ImuDriver::MPU9250_GetData(int16_t* accData, int16_t* magData, int16_t* gyroData)
{
