#ifndef _ROS_mesh_msgs_TriangleIndices_h
#define _ROS_mesh_msgs_TriangleIndices_h
...
namespace mesh_msgs
{
  ...
  class TriangleIndices : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "mesh_msgs/TriangleIndices"; };
