...
static const char BULKGETITEM[] = "dynamixel_sdk_examples/BulkGetItem";
  ...
  class BulkGetItemRequest : public ros::Msg
  {
    ...
    const char * getType(){ return BULKGETITEM; };
    const char * getMD5(){ return "f55042aa3aa499ad4bb778a05d278e5e"; };
  ...
  class BulkGetItemResponse : public ros::Msg
  {
    ...
    const char * getType(){ return BULKGETITEM; };
    const char * getMD5(){ return "e5963c91be0598b7f68fed70b98f2326"; };
