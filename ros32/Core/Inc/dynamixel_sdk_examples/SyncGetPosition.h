...
static const char SYNCGETPOSITION[] = "dynamixel_sdk_examples/SyncGetPosition";
  ...
  class SyncGetPositionRequest : public ros::Msg
  {
    ...
    const char * getType(){ return SYNCGETPOSITION; };
    const char * getMD5(){ return "533dfb55d158e8e581d9e0f578d53185"; };
  ...
  class SyncGetPositionResponse : public ros::Msg
  {
    ...
    const char * getType(){ return SYNCGETPOSITION; };
    const char * getMD5(){ return "a1a390f5c43969c5caaab57cf13dc84b"; };
